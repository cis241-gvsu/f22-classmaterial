...
* Projects are accepted up to 12 hours late for 75% credit.  Projects turned in
  more than 12 hours after the deadline will generally not be accepted,
  except in extenuating circumstances (e.g. severe illness, etc.).
  Any work done on an assignment
  after more than 12 hours after the deadline will not be counted for credit.
...
In many cases, attendance during the minilab portion will be the default
way of awarding credit.  If you miss a class with a minilab, you can receive
credit for the minilab by completing it on your own and showing me you completed
it during office hours (or reaching out privately on Piazza if you are unable
to attend office hours).  In some cases, minilabs may be submitted on PL (if this
...
fianl exam time as required by GVSU policy.
